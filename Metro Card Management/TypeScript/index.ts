...
async function EditRoutes(id:string,route:Ticket):Promise<void>
{
...
async function  DeleteRoutes(id:string):Promise<void>
 {
    const response=await fetch(`http://localhost:5184/api/ticket/${id}`,
        {
            method:'DELETE',
